      ...
      <div className="px-8 py-8 max-w-4xl mx-auto w-full">
        ...
        {loading ? (
          ...
          <div className="space-y-3">
            {cards.map((card) => (
              <CardRow key={card.cardNumber} card={card} onBlock={(updated) =>
...
function CardRow({ card, onBlock }) {
  ...
  return (
    <div className={`bg-white dark:bg-slate-900 border rounded-xl px-6 py-5 shadow-sm flex items-center justify-between gap-4 ${
      card.isDeactivated
